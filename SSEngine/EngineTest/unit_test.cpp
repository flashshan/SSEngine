...
#include "Engine\Core/Memory/HeapManager.h"
#include "Engine\Core\Memory\FixedSizeAllocator.h"
#include "Engine\Core\Math/Vector4.h"
#include "Engine\Core\Math\Matrix.h"
#include "Engine\Core\Template\List.h"
#include "Engine\Core\Template\Pointers.h"
...
bool main(int i_argc, char ** i_argl)
{
	bool res = true;
