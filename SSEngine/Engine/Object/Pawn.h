...
public:
	inline Pawn();
	explicit inline Pawn(const Transform &i_transform, const char *i_name = "defaultName", const char *i_type = "defaultType", const bool i_canCollide = true, const bool i_static = false);
...
FORCEINLINE void Pawn::SetController(WeakPtr<IController> i_controller)
{
